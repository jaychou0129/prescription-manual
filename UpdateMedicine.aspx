<%@ Page Title="更新藥品內容" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateMedicine.aspx.cs" Inherits="PrescriptionManual.UpdateMedicine" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <h1><%= Title %></h1>
        <h3 id="editing_title" runat="server"></h3>
    </div>
    ...
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 4px">
            <div class="btn-toolbar">
                ...
                <label>搜尋欲修改的藥品：</label>
                <div class="input-group">
                    <asp:TextBox runat="server" ID="updateMedicineSearch" ClientIDMode="Static" CssClass="form-control width-full" placeholder="請輸入藥品編號/名稱" />
                    <span class="input-group-btn">
                        <asp:LinkButton runat="server" ID="updateMedicineSearchBtn" OnClick="updateMedicineSearch_Clicked" CssClass="btn btn-primary">
                            <span class="glyphicon glyphicon-search"></span>
                        </asp:LinkButton>
                        <asp:Button runat="server" ClientIDMode="Static" ID="VirtualSearchButton1" CssClass="hidden" />
                    </span>
                </div>
                <div id="result_div" runat="server"></div>

            </div>
        </div>
    </div>

    <asp:Label ID="internalID" CssClass="hidden" ClientIDMode="Static" runat="server" Text="0" />
    <div runat="server" id="info_container_control"></div>
    <div class="row" style="display: none;" id="info_container">
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    <div id="medicineMCategoryContainer" class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="category_select" clientidmode="Static" runat="server" class="form-control" onchange="update_subcategory_select_updateMedicine()">
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="subcategory_select" clientidmode="Static" runat="server" class="form-control" onmousedown="update_subcategory_select_updateMedicine()">
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-inline">
                                <div class="form-group">
                                    ...
                                    <div id="medicineIDOriginal" clientidmode="Static" class="hidden" runat="server"></div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:LinkButton runat="server" CssClass="btn btn-success" Text="儲存" OnClick="SaveChanges" />
                            <a id="DeleteBtn" class="btn btn-danger">刪除藥品</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // Allows using enter to virtually press search button only when textbox is on focus
        $('#updateMedicineSearch').blur(function () {
            $('#VirtualSearchButton1').prop('disabled', true);
        })
        $('#updateMedicineSearch').focus(function () {
            $('#VirtualSearchButton1').prop('disabled', false);
        })

        $('#medicineID, #category_select, #subcategory_select').change(function () {
            verifyID(true);
        })
